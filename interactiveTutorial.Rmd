...
<!-- # Lade das Shapefile "NI_heart.shp" in eine Variable deiner Wahl: -->
<!-- variablennameDeinerWahl <- st_read(dsn = "NI_heart.shp") -->
<!-- ``` -->
...
herzpolygonpuffer <- ...("NI_heart.shp") %>% # Polygon einlesen
  st_transform(crs = 32632) %>% # Transformation
  st_buffer(dist = ...) # Puffer

mapview(herzpolygonpuffer) # Visualisierung
```
