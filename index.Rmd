...
```{r}
data.frame.beispiel <- data.frame(Zahlen = 40:eine.echte.zahl,
                                 Text = ein.beispieltext,
                                 text.der.aussieht.wie.eine.zahl)
...
Tabellen haben eindeutige Spaltennamen, Spaltennummern und Zeilennummern, mit denen die Daten darin addressiert werden können. Dafür gibt es verschiedene Möglichkeiten, hier ein paar Beispiele:

```{r}
print("Der Wert vor dem Komma in eckigen Klammern adressiert die Zeilen der Tabelle, ...")
data.frame.beispiel[3, ] # nur die dritte Zeile der Tabelle

print("... der Wert hinter dem Komma adressiert die Spalten (wahlweise Name oder Nummer)")
